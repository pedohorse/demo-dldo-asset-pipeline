...
class CacheAsset(Asset):
    ...
    """
    def create_new_version(self, source: Tuple[str, str], frame_range: Tuple[int, int], is_sim: bool = False, version_id: Optional[VersionType] = None, *, extra_env_requirements: Optional[Dict[str, str]] = None, dependencies: Iterable["AssetVersion"] = ()):
        """
